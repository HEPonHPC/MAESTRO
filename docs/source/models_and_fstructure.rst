...
.. _mfstrodf_f_structure:

Function Structure
~~~~~~~~~~~~~~~~~~~~~~~~

The f_structure functions in MF-STRO-DF are available via the functions in ``mfstrodf.Fstructure``
and they are stored in the file at path ``mfstrodf/fstructure.py``.

.. _mfstrodf_f_structure_avail_func:

Available f_structure functions
********************************

At this time, the following functions are available in ``mfstrodf.Fstructure``::
...
.. _mfstrodf_f_structure_avail_func_appr_tuning_objective:
...
The following f_structure object should be used in :ref:`configuration inputs<mfstrodf_input_config>`
...
explaining different lines of the code::
  ...
  def my_f_structure_function(self, parameter=None, use_scaled=False):
    """
    In mfstrodf/fstructure.py, create a function with three arguments
...
Then the following f_structure object should be used in :ref:`configuration inputs<mfstrodf_input_config>`
